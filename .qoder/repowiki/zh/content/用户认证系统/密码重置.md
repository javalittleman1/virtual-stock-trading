...
**图表来源**
- [components/forgot-password-form.tsx:27-45](file://components/forgot-password-form.tsx#L27-L45)
...
- 功能要点
  ...
  - 加载态控制与按钮禁用
- 关键实现路径
  - 表单提交与 API 调用：[handleForgotPassword:27-45](file://components/forgot-password-form.tsx#L27-L45)
  - UI 切换与错误展示：[render logic:47-102](file://components/forgot-password-form.tsx#L47-L102)
...
- resetPasswordForEmail
  ...
  - 实现参考：[resetPasswordForEmail 调用:35-37](file://components/forgot-password-form.tsx#L35-L37)
- updateUser
  - 作用：在用户已有活跃会话下更新其密码
...
**图表来源**
- [components/forgot-password-form.tsx:35-37](file://components/forgot-password-form.tsx#L35-L37)
...
- URL 参数解析
  ...
  - 实现参考：[redirectTo 配置:35-37](file://components/forgot-password-form.tsx#L35-L37)
- 令牌有效性检查
...
- 进度指示
  ...
  - 参考：[加载态与按钮禁用:86-88](file://components/forgot-password-form.tsx#L86-L88)、[加载态与按钮禁用:69-71](file://components/update-password-form.tsx#L69-L71)
- 成功确认
  - 发送邮件成功后切换为"检查邮箱"卡片提示
  - 参考：[成功 UI 切换:49-61](file://components/forgot-password-form.tsx#L49-L61)
- 错误提示
  - 统一错误展示页面，支持错误码与消息
  - 参考：[错误页:1-52](file://app/auth/error/page.tsx#L1-L52)

**章节来源**
- [components/forgot-password-form.tsx:49-61](file://components/forgot-password-form.tsx#L49-L61)
- [components/forgot-password-form.tsx:85-88](file://components/forgot-password-form.tsx#L85-L88)
- [components/update-password-form.tsx:68-71](file://components/update-password-form.tsx#L68-L71)
- [app/auth/error/page.tsx:1-52](file://app/auth/error/page.tsx#L1-L52)
...
- 无法发送重置邮件
  ...
  - 参考：[redirectTo 配置位置注释:34-37](file://components/forgot-password-form.tsx#L34-L37)
- 重置链接无效或过期
...
**章节来源**
- [components/forgot-password-form.tsx:34-37](file://components/forgot-password-form.tsx#L34-L37)
- [app/auth/error/page.tsx:1-52](file://app/auth/error/page.tsx#L1-L52)
...
## 结论
本项目的密码重置功能通过 ForgotPasswordForm 与 UpdatePasswordForm 两个核心组件，结合 Supabase Auth 的重置密码能力，实现了从邮箱验证、重置邮件发送到新密码更新的完整闭环。配合统一的错误页与会话代理机制，既保证了安全性，也提升了用户体验。建议在生产环境中严格遵循环境变量配置与令牌有效期策略，并持续关注 Supabase 的最新安全实践。
...
- 代码示例路径
  ...
  - ForgotPasswordForm 实现：[components/forgot-password-form.tsx:1-106](file://components/forgot-password-form.tsx#L1-L106)
  ...
  - 令牌验证路由：[app/auth/confirm/route.ts:1-30](file://app/auth/confirm/route.ts#L1-L30)
